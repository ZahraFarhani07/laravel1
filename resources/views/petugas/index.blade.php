            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route ('petugas.create') }}" class="btn btn-sm btn-primary">
                  <i class="fas fa-plus"></i> Create Petugas</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('petugas.show', $value->id) }}" class="btn btn-small btn-info"  style="margin-right: 8px;">Detail</a>
                                <a href="{{ route('petugas.edit', $value->id) }}" class="btn btn-small btn-warning" style="margin-right: 8px;">Edit</a>
